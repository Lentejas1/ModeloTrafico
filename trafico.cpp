...
void desaceleracion_exponencial(){
    double X[N][5];       /* Fila tiempo, columna coche*/
    double V[N][5];       /* Fila tiempo, columna coche*/
    double K[5][4], L[5][4];          /*Filas son coches y columnas K sub algo*/
    double D[N];
...
void desaceleracion_sinusoidal(double omega){
    double X[N][5];       /* Fila tiempo, columna coche*/
    double V[N][5];       /* Fila tiempo, columna coche*/
    double K[5][4], L[5][4];          /*Filas son coches y columnas K sub algo*/
    double D[N];
...
void desaceleracion_inmediata_reaccion(int reaccion){
    double X[N][5];       /* Fila tiempo, columna coche*/
    double V[N][5];       /* Fila tiempo, columna coche*/
    double K[5][4], L[5][4];          /*Filas son coches y columnas K sub algo*/
    double D[N];
    ...
    for (int i=0; i<N-1; i++){
        ...
        if (i < i_col){
            ...
            for (int j=1; j<5; j++){
                ...
                K[j][1] = -((V[i][j] + dt*0.5*K[j][0]) - (V[i-reaccion][j-1]))/(fabs((X[i][j] + dt*0.5*L[j][0]) - (X[i-reaccion][j-1]) + l/d ));
                L[j][1] = V[i][j] + dt*0.5*K[j][0];

                K[j][2] = -((V[i][j] + dt*0.5*K[j][1])- (V[i-reaccion][j-1]))/(fabs((X[i][j] + dt*0.5*L[j][1]) - (X[i-reaccion][j-1]) + l/d));
                L[j][2] = V[i][j] + dt*0.5*K[j][1];

                K[j][3] = -((V[i][j] + dt*K[j][2]) - (V[i-reaccion][j-1]))/(fabs((X[i][j] + dt*L[j][2]) - (X[i-reaccion][j-1]) + l/d ));
                L[j][3] = V[i][j] + dt*K[j][2];
            }
...
void desaceleracion_exponencial_reaccion(int reaccion){
    double X[N][5];       /* Fila tiempo, columna coche*/
    double V[N][5];       /* Fila tiempo, columna coche*/
    double K[5][4], L[5][4];          /*Filas son coches y columnas K sub algo*/
    double D[N];
...
void desaceleracion_sinusoidal_reaccion(int reaccion, double omega){
    double X[N][5];       /* Fila tiempo, columna coche*/
    double V[N][5];       /* Fila tiempo, columna coche*/
    double K[5][4], L[5][4];          /*Filas son coches y columnas K sub algo*/
    double D[N];
...
int main(){
    ...
    desaceleracion_inmediata_reaccion(reaction_steps);
    desaceleracion_exponencial_reaccion(reaction_steps);
    desaceleracion_sinusoidal_reaccion(reaction_steps, omega);
